      ...
      if (fileName.endsWith(".xlsx") || fileName.endsWith(".xls")) {
        ...
        reader.onload = (e) => {
          ...
          if (jsonData.length === 0) {
            toast.warning("This file is empty. Please choose a non-empty file.");
        ...
        toast.warning("Please select a valid Excel file with extension .xlsx or .xls");
  ...
  return (
    <>
      <div className="convert_main_container">
        ...
        <div className="converted_other_container"></div>
      </div>
    </>
  );
}
